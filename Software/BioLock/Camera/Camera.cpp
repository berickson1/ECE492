...
void Camera::imageToBuffer(char* buffer){
	...
	for (int i = 0; i < CAM_HEIGHT; i++){
		memcpy((void*)(buffer + ((CAM_HEIGHT - i - 1) * CAM_WIDTH * 4)), (void*)((char*)SRAM_0_BASE + (i * CAM_WIDTH * 4)), CAM_WIDTH*4);
	}
...
void Camera::init(){
	...
	alt_up_av_config_write_D5M_cfg_register(camConfig, 0x12, 0x38);
	//Use PLL
